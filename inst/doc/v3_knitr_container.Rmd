---
title: "`plotly` and `knitr_container` Examples"
...
vignette: >
  %\VignetteIndexEntry{4 plotly and knitr Examples}
...
```
In these situations it is better to apply function `add_as_plotly` first.
